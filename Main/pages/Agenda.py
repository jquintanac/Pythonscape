...
with st.sidebar:
    ...
    stoggle('Do you need an extra hint?', "Her name is Sarah Q. Lake. Annotate her phone number.")

# Titulo


st.title('')
st.markdown("<h4 style='text-align: center; color: white;'>Agenda", unsafe_allow_html=True)
