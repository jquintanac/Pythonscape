...
with col1:
    st.image('https://github.com/jquintanac/Pythonscape/blob/main/imgs/peoplef.png?raw=true')
    boton=st.button('People finder')
    if boton:
        switch_page('peoplef')

with col2:
    st.image('https://github.com/jquintanac/Pythonscape/blob/main/imgs/flight.png?raw=true')
    boton=st.button('Flight tracker')
    if boton:
        switch_page('flighttracker')

with col3:
    st.image('https://github.com/jquintanac/Pythonscape/blob/main/imgs/logocar.png?raw=true')
