...
st.title('')
st.markdown("<h4 style='text-align: center; color: white;'>Car finder", unsafe_allow_html=True)


# Contenido


c=st.text_input('Enter the full name with no symbols you want to check', '')
