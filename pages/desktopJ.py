...
st.text('')
st.sidebar.image("https://github.com/jquintanac/Pythonscape/blob/main/imagenes/james.png?raw=true")
...
st.title('')
st.markdown("<h4 style='text-align: center; color: black;'>Desktop", unsafe_allow_html=True)
